package xyz.iwolfking.woldsvaults.custom.models.gear;
...
public class Plushies {
    ...
    public static final HandHeldModel GIRAFFEKING;
    ...
    static {
        ...
        GIRAFFEKING = (HandHeldModel)REGISTRY.register((HandHeldModel)(new HandHeldModel(VaultMod.id("gear/plushie/thegiraffeking"), "GiraffeKing the Benevolent")).properties(new DynamicModelProperties().allowTransmogrification().discoverOnRoll()));
    }
}
